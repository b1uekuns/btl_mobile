...
const MEMBERS = [
  {
    ...
    tasks: 'Màn hình Ngân hàng câu hỏi, Form tạo/sửa câu hỏi, SearchFilterBar, QuestionCard component',
    status: '✅ Hoàn thành',
  },
  {
    ...
    tasks: 'Màn hình Danh sách đề thi, Modal tạo đề, tích hợp ExamService, Context actions cho Exam',
    status: '✅ Hoàn thành',
  },
  {
    ...
    tasks: 'Màn hình Chi tiết đề thi, Modal ngân hàng câu hỏi, tính năng thêm/xóa câu hỏi khỏi đề',
    status: '✅ Hoàn thành',
  },
  {
    ...
    tasks: 'Màn hình Thống kê, Animation đếm số, biểu đồ phân bố độ khó, AppContext + AsyncStorage',
    status: '✅ Hoàn thành',
  },
]
  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      ...
      <View style={styles.hero}>
        ...
        <Text style={styles.heroTitle}>[Tên Nhóm]</Text>
        <Text style={styles.heroSub}>Môn: Phát triển ứng dụng điện thoại</Text>
      ...
      <Text style={styles.footer}>
        Dự án được phát triển cho môn học Phát triển Ứng dụng Di động.
        Toàn bộ dữ liệu lưu trữ cục bộ trên thiết bị.
      </Text>
    </ScrollView>
  )
}
...
const styles = StyleSheet.create({
  ...
  hero: { backgroundColor: Colors.primaryLight, borderRadius: 14, padding: 20, alignItems: 'center', marginBottom: 16, borderWidth: 1, borderColor: Colors.primary + '30' },
  heroIcon: { fontSize: 40, marginBottom: 8 },
  heroTitle: { fontSize: 20, fontWeight: '800', color: Colors.primary },
  heroSub: { fontSize: 13, color: Colors.muted, marginTop: 4, textAlign: 'center' },
  sectionTitle: { fontSize: 13, fontWeight: '700', color: Colors.muted, textTransform: 'uppercase', letterSpacing: 0.5, marginTop: 16, marginBottom: 10 },
  card: { backgroundColor: Colors.surface, borderRadius: 10, padding: 14, borderWidth: 1, borderColor: Colors.border },
  techRow: { flexDirection: 'row', paddingVertical: 6, borderBottomWidth: 1, borderBottomColor: Colors.border },
  techKey: { width: 90, fontSize: 13, fontWeight: '600', color: Colors.text },
  techVal: { flex: 1, fontSize: 13, color: Colors.muted },
  memberCard: { backgroundColor: Colors.surface, borderRadius: 10, padding: 14, marginBottom: 10, borderWidth: 1, borderColor: Colors.border },
  ...
  memberRole: { fontSize: 13, fontWeight: '600', color: Colors.primary, marginBottom: 4 },
  memberTasks: { fontSize: 13, color: Colors.muted, lineHeight: 20 },
  footer: { marginTop: 20, fontSize: 12, color: Colors.muted, textAlign: 'center', lineHeight: 18 },
})
